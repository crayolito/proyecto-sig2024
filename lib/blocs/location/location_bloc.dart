...
class LocationBloc extends Bloc<LocationEvent, LocationState> {
  StreamSubscription<geo.Position>? positionSteam;
  ...
  Future<geo.Position> getActualLocation() async {
  ...
  void startFollowingUser() {
    ...
    positionSteam = geo.Geolocator.getPositionStream().listen((position) {
